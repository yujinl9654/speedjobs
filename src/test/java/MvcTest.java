...
public abstract class MvcTest {
	...
	protected ResultActions postAction(String url, String inputJson, String bearerToken)
		throws Exception {
		return this.mockMvc
			.perform(post(url)
				.header(AUTH_HEADER, bearerToken)
	...
	protected ResultActions postAction(String url, MockMultipartFile multipartFile)
		throws Exception {
		return this.mockMvc
	...
	protected ResultActions putAction(String url, String inputJson, String bearerToken)
		throws Exception {
		return this.mockMvc
			.perform(put(url)
				.header(AUTH_HEADER, bearerToken)
	...
	protected ResultActions patchAction(String url, String inputJson, String bearerToken)
		throws Exception {
		return this.mockMvc
			.perform(patch(url)
				.header(AUTH_HEADER, bearerToken)
